...
#         return snr
    ...
    if ("idx-train.pkl" in args.index_path) or ("idx-val.pkl" in args.index_path):
        ...
        df['label'] = ['ukiyo_e']*200 + ['post_impressionism']*200 + ['romanticism']*200 + ['renaissance']*200 + ['baroque']*200 # !!!!
...
#         return {"pixel_values": pixel_values, "input_ids": input_ids}
    ...
    if 'checkpoint-0' in args.output_dir:
        ...
        unet.half()
        unet.cuda()
    elif "retrain" in args.output_dir:
        print(args.output_dir)
    ...
    if "idx-train.pkl" in args.index_path:
        ...
        # pass
        filename = os.path.join('{}/features-{}/sd-lora-gen-keys-{}-{}-{}-{}-{}.npy'.format(
            args.output_dir, 
            args.e_seed, 
            args.split, args.K, args.Z, args.f, args.t_strategy))
